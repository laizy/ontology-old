...
func (self *StateStore) GetMerkleProof(m, n uint32) ([]common.Uint256, error) {
	return self.merkleTree.InclusionProof(m, n)
}
...
func (self *StateStore) getMerkleTreeKey() ([]byte, error) {
